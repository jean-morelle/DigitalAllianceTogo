import {
    BookOpen, ClipboardList, CreditCard, FileText, History, LayoutDashboard, Package, Settings, Truck, Wallet, Wrench, type LucideIcon,
} from 'lucide-react';
...
export const NAVIGATION: EntreeNavigation[] = [
    ...
    { chemin: '/catalogue', libelle: 'Catalogue', icone: BookOpen, roles: [Roles.Catalogue] },
